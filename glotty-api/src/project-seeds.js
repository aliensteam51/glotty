  ...
  .then(() => {
    feathersClient.service('organizations').create(organization)
      .then((org) => {
        ...
        feathersClient.service('users').create(Object.assign(users[2], {organizationId: org[1]._id}))
        feathersClient.service('users').create(Object.assign(users[3], {organizationId: org[1]._id}))
        feathersClient.service('users').create(Object.assign(users[4], {organizationId: org[1]._id}))
        feathersClient.service('users').create(Object.assign(users[5], {organizationId: org[1]._id}))
